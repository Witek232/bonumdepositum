...
Dialog Justyna z Tryfonem to w dużej mierze seria pytań. Justyn nie wygłasza monologów, nie przytłacza rozmówco erudycją. Zamiast tego zadaje pytania, które prowadzą Tryfona do samodzielnych odkryć. "Czy nie czytaliście w Piśmie...?", "Czyż nie jest napisane...?", "Co myślisz o tym fragmencie...?" – te pytania nie są retoryczne w pejoratywnym sensie. To autentyczne zaproszenie do wspólnego badania źródeł.

Ta metoda ma głębokie korzenia sokratejskie. Justyn, będąc wcześniej filozofem platońskim, przyswoił sobie majeutykę – sztukę położniczą filozofii, gdzie nauczyciel nie wpaja gotowych odpowiedzi, ale pomaga rozmówco "urodzić" prawdę, którą ten już w pewnym sensie w sobie nosi.
...
Ta metoda hermeneutyczna może się wydawać współczesnemu czytelnikowi naciągana lub dowolna. But jest w niej głębsza mądrość o naturze argumentacji. Justyn pokazuje, że te same teksty można czytać na różnych poziomach głębokości. Nie neguje dosłownego, historycznego sensu – ale pokazuje, że nie jest to sens ostateczny, że tekst nosi w sobie głębsze znaczenie.

To niezwykle ważne dla sztuki perswazji: uznanie, że dana interpretacja może być częściowo słuszna, but niekompletna. W debacie współczesnej mamy tendencję do myślenia binarnego: albo mam rację, albo ty. Albo ta interpretacja jest prawdziwa, albo tamta. Justyn pokazuje trzecią możliwość: obie interpretacje mogą zawierać element prawdy, but jedna jest pełniejsza, głębsza, bardziej kompleksowa.
...
Dialog Justyna z Tryfonem rozciąga się na dwa dni. To nie jest szybka wymiana zdań, but długa, cierpliwa rozmowa, która pozwala na dogłębne zbadanie wszystkich aspektów zagadnienia. Justyn nie próbuje "wygrać" dyskusji efektownym argumentem. Zamiast tego buduje, krok po kroku, kumulatywną argumentację.
...
Mimo że dyskusza dotyczy kwestii najgłębszych – natury Boga, tożsamości Mesjasza, zbawienia – ton Dialogu pozostaje zadziwiająco spokojny i rzeczowy. Oczywiście, Justyn jest pasjonatem swojej sprawy. But ta pasja nigdy nie przekłada się na osobiste ataki, wyśmiewanie czy pogardę.
...
Nie można skutecznie dyskutować o rzeczach, których się nie zna. Brzmi to jak truism, but we współczesnej debacie publicznej jest to prawda często ignorowana. Ile razy widzieliśmy "ekspertów" wypowiadających się na tematy, o których mają tylko powierzchowną wiedzę? Ile razy słyszeliśmy kogoś cytującego tekst, którego nigdy naprawdę nie przeczytał, tylko zna z drugiej ręki?

Justyn pokazuje, że prawdziwa argumentacja wymaga pracy. Wymaga dogłębnego zbadania źródeł, zrozumienia kontekstu, rozważenia różnych interpretacji. I to nie dlatego, że erudycja sama w sobie ma jakąś wartość, but dlatego, że jeśli traktuję prawdę poważnie, muszę traktować poważnie także materiał, który ją dotyczy.
...
Kluczową techniką Justyna jest nieustanne wskazywanie na to, co łączy go z Tryfonem, zanim przejdzie do tego, co ich dzieli. Obaj wierzą w jedynego Boga. Obaj uznają autorytet Pisma Hebrajskiego. Obaj czekają na Mesjasza. Obraj wierzą w obietnice dane Abrahamowi.
...
Ta strategia ma głęboką mądrość psychologiczną. Ludzie są o wiele bardziej otwarci na rozważenie nowych perspektyw, gdy czują, że ich fundamentalne przekonania są szanowane. Kiedy zaczynam od podkreślenia wspólnych wartości, rozmówco nie czuje się tak bardzo zagrożony – nie jest to całkowita negacja jego światopoglądu, but propozycja jego rozwinięcia czy doprecyzowania.
...
Justyn pokazuje, że paradoksalnie, przyznanie się do trudności wzmacnia argumentację. Kiedy sam formułuję najsilniejszą wersję zarzutu i pokazuję, że mimo wszystko moja pozycja się broni, staję się o wiele bardziej przekonujący niż gdybym udawał, że zarząd nie istnieje.

### Cel dialogu: prawda, nie zwycięcie
...
To nie jest porażka Justyna. To właśnie sukces autentycznego dialogu. Bo celem nie było natychmiastowe zwycięcie, but zasiane ziarno, które może kiełkować. Dialog miał otworzyć umysł Tryfona na nowe możliwości, dać mu do przemyślenia nowe argumenty, pokazać, że chrześcijańska interpretacja Pisma nie jest absurdalna, but intelektualnie solidna.
...
I tu dotykamy rdzenia problemu współczesnego dyskursu. Zredukowaliśmy wszelką wymianę poglądów do modelu debaty. Polityka to debata. Media społecznościowe to debata. Nawet prywatne rozmowy między ludźmi często przyjmują formę debatu – kto ma rację? Kto wygra?

Justyn oferuje nam alternatywę. Model rozmowy, gdzie nie chodzi o to, kto wygra, but o to, czy wspólnie dojdziemy bliżej prawdy. Model, gdzie szacunek dla rozmówco nie jest oznaką słabości, but warunek autentycznej wymiany. Model, gdzie przyznanie się do niewiedzy czy wątpliwości nie jest kompromitacją, but oznaką intelektualnej uczciwości.
...
Justyn Męczennik, filozof z II wieku, który rozmawiał z żydowskim myślicitelem o najgłębszych kwestiach bytu i wiary, pokazuje nam drogę. To nie jest łatwa droga. Wymaga wysiłku intelektualnego, emocjonalnej dojrzałości, pokóry epistemicznej i autentycznego szacunku dla drugiego człowieka.
